...
/*
 * AST2400 SoC definitions
*/
static AspeedSoCInfo aspeed_soc_info = {
...
static void pnv_lpc2ahb_instance_init(Object *obj)
{
    ...
    AspeedSoCInfo *soc = &aspeed_soc_info;
...
static const TypeInfo pnv_lpc2ahb_info = {
    ...
    /* TODO: add a lpc2ahb class */
    .class_data    = (void *) &aspeed_soc_info,
};
...
PnvLpc2Ahb *pnv_lpc2ahb_create(AspeedSio *sio, Error **errp)
{
    ...
    obj = object_new(TYPE_PNV_LPC2AHB);
