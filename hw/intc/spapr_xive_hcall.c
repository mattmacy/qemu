                                          ...
                                          target_ulong *args)
{
    ...
    if (xive_router_get_ive(XIVE_ROUTER(xive), lisn, &ive)) {
        return H_P2;
    }
                                            ...
                                            target_ulong *args)
{
     ...
     * target.
     */
    if (spapr_xive_target_to_eq(xive, target, priority, &eq_blk, &eq_idx)) {
        return H_P3;
    }
...
out:
    if (xive_router_set_ive(xrtr, lisn, &new_ive)) {
        return H_HARDWARE;
    }
                                            ...
                                            target_ulong *args)
{
    ...
    args[0] = spapr_xive_vp_to_target(xive, vp_blk, vp_idx);
                                         ...
                                         target_ulong *args)
{
    ...
    if (xive_router_get_eq(XIVE_ROUTER(xive), eq_blk, eq_idx, &eq)) {
        return H_HARDWARE;
    }
                                           ...
                                           target_ulong *args)
{
    ...
    if (spapr_xive_target_to_vp(xive, target, &vp_blk, &vp_idx)) {
        return H_HARDWARE;
    }
